...
yelp_df.write.json("s3://yelp-output-data-014/business_final/", mode = "overwrite")
tip_sent.write.json("s3://yelp-output-data-014/tips_final/", mode = "overwrite")
checkin_df.write.json("s3://yelp-output-data-014/checkin_final/", mode = "overwrite")
rev_sentiment.write.json("s3://yelp-output-data-014/review_final/", mode = 'overwrite')
df.write.json("s3://yelp-output-data-014/user_final/", mode = 'overwrite')
